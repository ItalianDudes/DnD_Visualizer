...
import it.italiandudes.dnd_visualizer.client.javafx.scene.tutorial.SceneTutorialPage1;
...
public final class ControllerSceneTutorial2 {
            ...
            protected Task<Void> createTask() {
                return new Task<Void>() {
                    ...
                    protected Void call() {
                        ...
                        Platform.runLater(ControllerSceneTutorial2.this::postInitialize);
                        return null;
                    }
                };
            }
