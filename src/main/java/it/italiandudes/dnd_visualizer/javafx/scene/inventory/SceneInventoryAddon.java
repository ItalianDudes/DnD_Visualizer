...
public final class SceneInventoryAddon {

    // Scene Generator
    @NotNull
    public static SceneController getScene() {
        try {
            FXMLLoader loader = new FXMLLoader(Defs.Resources.get(JFXDefs.Resources.FXML.Inventory.FXML_INVENTORY_ADDON));
            Parent root = loader.load();
            ControllerSceneInventoryAddon controller = loader.getController();
    ...
    @NotNull
    public static SceneController getScene(@NotNull final ItemContainer container, @NotNull final String addonName) {
        try {
            FXMLLoader loader = new FXMLLoader(Defs.Resources.get(JFXDefs.Resources.FXML.Inventory.FXML_INVENTORY_ADDON));
            Parent root = loader.load();
            ControllerSceneInventoryAddon controller = loader.getController();
            controller.setAddonName(addonName);
            controller.setItemContainer(container);
            controller.configurationComplete();
            return new SceneController(root, controller);
        } catch (IOException e) {
